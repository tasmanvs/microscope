...
class Ui_main_window_(object):
    def setupUi(self, main_window_, camera_module):
        ...
        main_window_.resize(170, 453)
        self.central_widget_ = QtWidgets.QWidget(main_window_)
        self.central_widget_.setObjectName("central_widget_")
        self.widget = QtWidgets.QWidget(self.central_widget_)
        self.widget.setGeometry(QtCore.QRect(0, 0, 168, 435))
        ...
        self.widget1.setGeometry(QtCore.QRect(0, 20, 167, 67))
        ...
        self.start_timelapse_btn_ = QtWidgets.QPushButton(self.widget1)
        self.start_timelapse_btn_.setObjectName("start_timelapse_btn_")
        self.horizontalLayout_2.addWidget(self.start_timelapse_btn_)
        self.stop_timelapse_btn_ = QtWidgets.QPushButton(self.widget1)
        ...
        self.timelapse_delay_spinbox_ = QtWidgets.QDoubleSpinBox(self.widget1)
        ...
        self.stop_video_recording_btn_ = QtWidgets.QPushButton(self.widget)
        ...
        self.save_last_20_seconds_btn_ = QtWidgets.QPushButton(self.widget)
        ...
        self.file_name_input_ = QtWidgets.QLineEdit(self.widget)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 170, 37))
